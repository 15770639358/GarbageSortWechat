...
Page({
  ...
  data: {
    ...
    sorts:[{
      color:"#664035",
      bgcolor: "#d6d5d4",
      logo:"../../resource/images/HouseholdfoodWaste.jpg",
      name:"湿垃圾",
      ...
      action: ["纯流质的食物垃圾，如牛奶等，应直接倒进下水口","有包装物的湿垃圾应将包装物去除后分类投放，包装物请投放到对应的可回收物或干垃圾容器"],
        ...
        color: "#2c2b27",
        bgcolor: "#e9e8e6",
        logo: "../../resource/images/ResidualWaste.png",
        name: "干垃圾",
        ...
        color: "#e73322",
        bgcolor: "#c8e2f8",
        logo: "../../resource/images/HazardouAwaste.jpg",
        name: "有害垃圾",
        ...
        color: "#014782",
        bgcolor: "#e9e8e6",
        logo: "../../resource/images/RecycleableWaste.jpg",
        name: "可回收物",
  ...
  commit:function(){
      wx.navigateTo({
        url: '/pages/noResultCommit/noResultCommit?keyword='+this.data.keyword,
      })
  },
